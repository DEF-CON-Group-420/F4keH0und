...
- Endpoint-name presets (`RpcEndpointBait*`, `ApiEndpointBait*`) apply tuned correlation weights in alert scoring: `Correlated +18`, `Unknown -8`, `Uncorrelated -20`, plus trigger-source quality boost (`Sysmon:EventID11 +3`, `WindowsSecurity:EventID4663 +1`).
