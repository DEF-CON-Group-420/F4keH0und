...
function Get-PrivateF4keH0undDefaultTelemetryConnectorPack {
    ...
    return [PSCustomObject]@{
        ...
        Presets = @(
            ...
            [PSCustomObject]@{
                PresetId = 'CanaryTextPackSysmonFileCreate'
                TriggerType = 'FileAccess'
                TriggerSource = 'Sysmon:EventID11'
                SignalCount = 2
                Confidence = 89
            ...
            [PSCustomObject]@{
                PresetId = 'CanaryTextPackSecurityObjectAccess'
                TriggerType = 'FileAccess'
            ...
            [PSCustomObject]@{
                PresetId = 'AdminTroubleshootingPackSysmonFileCreate'
                TriggerType = 'FileAccess'
                TriggerSource = 'Sysmon:EventID11'
                SignalCount = 2
                Confidence = 90
            ...
            [PSCustomObject]@{
                PresetId = 'AdminTroubleshootingPackSecurityObjectAccess'
                TriggerType = 'FileAccess'
                TriggerSource = 'WindowsSecurity:EventID4663'
                SignalCount = 2
                Confidence = 88
